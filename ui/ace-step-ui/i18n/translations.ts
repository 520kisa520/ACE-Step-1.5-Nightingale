...
export const translations = {
  en: {
    ...
    // Username Modal
    welcomeTitle: 'Welcome to Nightingale Healing AI',
    welcomeSubtitle: 'Enter your name to start creating healing instrumental music',
    yourName: 'Your Name',
    enterYourName: 'Enter your name',
    getStarted: 'Get Started',
    gettingStarted: 'Getting Started...',
    yourMusicYourWay: 'Arts × Medicine × Engineering — Audiovisual healing music generation',
  ...
  zh: {
    ...
    // Username Modal
    welcomeTitle: '欢迎使用夜莺视听疗愈 AI',
    welcomeSubtitle: '输入您的名字，开始创作疗愈纯音乐',
    yourName: '您的名字',
    enterYourName: '请输入您的名字（支持中文，至少 2 个字符）',
    getStarted: '开始使用',
    gettingStarted: '正在启动...',
    yourMusicYourWay: '艺术学 × 医学 × 工学 · 视听疗愈 AI 研究与实践',
    usernameMinLength: '用户名至少需要 2 个字符',
    usernameInvalidChars: '用户名只能包含字母、数字、下划线和破折号（中文也可以）',
